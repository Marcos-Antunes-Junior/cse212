...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Bob appeared in the queue more than twice.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: When a person's turn was 0, the value was not being enqueued.
    ...
    // Defect(s) Found: When a person's turn was a negative number, the value was not being enqueued.
